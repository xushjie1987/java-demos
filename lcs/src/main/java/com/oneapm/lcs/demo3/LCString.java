/**
 * Project Name:lcs
 * File Name:LCString.java
 * Package Name:com.oneapm.lcs.demo3
 * Date: 
 * Copyright (c) 2016, All Rights Reserved.
 *
 */
package com.oneapm.lcs.demo3;

import java.util.stream.IntStream;

/**
 * ClassName:LCString <br/>
 * Function: <br/>
 * Date: <br/>
 * 
 * @author xushjie
...
public class LCString {
    ...
    public static void getLCString(char[] str1,
                                   char[] str2) {
        int i, j;
        int len1, len2;
        len1 = str1.length;
        ...
        for (i = 0; i < len2; i++) {
            ...
            System.out.println("=====================第i=" + i + "轮循环========================");
            System.out.print("     max: ");
            IntStream.of(max)
                     .forEach(System.out::print);
            System.out.println();
            System.out.print("maxIndex: ");
            IntStream.of(maxIndex)
                     .forEach(System.out::print);
            System.out.println();
            System.out.print("       c: ");
            IntStream.of(c)
    ...
    public static void main(String[] args) {
        ...
        String str2 = new String("hexellox");
